<template>
    <div class="list-item--release">
        <slot name="standard-header"/>
        <slot name="standard-image"/>
        <div class="release__buttons">
            <a class="btn btn--bandcamp" v-if="item.bandcamp" :href="item.bandcamp" target="_blank" rel="noreferrer">
                <i class="fa fa-bandcamp"></i> Bandcamp
            </a>
            <a class="btn btn--spotify" v-if="item.spotify" :href="item.spotify" target="_blank" rel="noreferrer">
                <i class="fa fa-spotify"></i> Spotify
            </a>
        </div>
        <div class="cols cols-2 release__description-and-tracks">
            <div class="col release__description">
                <slot name="description"/>
            </div>
            <div v-if="item.trackList" class="col release__tracks">
                <h3>
        ...
        <div class="list-item__related release__videos" v-if="item.videoItems && item.videoItems.length > 0">
            <h3>Videos</h3>
